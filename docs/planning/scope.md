...
| -------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Digital Menu   | Customer     | Browse the menu, categories, item details, options, availability, preparation time, and final Toman prices. No cart submission or order tracking. |
...
| Customer menu          | Mobile-first QR menu for browse/search/filter, item options, availability, preparation-deadline minutes, and final Toman price. No checkout or order submission.                                                                                                                                                                                                                                                                |
...
- The digital menu is mobile-first and browse-only. It displays final Toman prices, item options, current availability, and preparation-deadline minutes without exposing checkout, payment, or order-tracking controls.
